...
class Env extends Client\AbstractObject implements Client\IdAble, Node
{
     ...
     */
    public function withGitCommitInput(string $name, GitCommit $value, string $description): Env
    {
        $innerQueryBuilder = new \Dagger\Client\QueryBuilder('withGitCommitInput');
        $innerQueryBuilder->setArgument('name', $name);
        $innerQueryBuilder->setArgument('value', $value);
        $innerQueryBuilder->setArgument('description', $description);
        return new \Dagger\Env($this->client, $this->queryBuilderChain->chain($innerQueryBuilder));
     ...
     */
    public function withGitCommitOutput(string $name, string $description): Env
    {
        $innerQueryBuilder = new \Dagger\Client\QueryBuilder('withGitCommitOutput');
        $innerQueryBuilder->setArgument('name', $name);
        $innerQueryBuilder->setArgument('description', $description);
        return new \Dagger\Env($this->client, $this->queryBuilderChain->chain($innerQueryBuilder));
    }
     ...
     */
    public function withWorkspaceMigrationInput(string $name, WorkspaceMigration $value, string $description): Env
    {
     ...
     */
    public function withWorkspaceModuleInput(string $name, WorkspaceModule $value, string $description): Env
    {
